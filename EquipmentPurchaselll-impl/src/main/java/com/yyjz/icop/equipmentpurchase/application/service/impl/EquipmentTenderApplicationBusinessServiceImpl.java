 ...
 */
@Service(value="equipmentTenderApplicationEvent")
public class EquipmentTenderApplicationBusinessServiceImpl implements IBusinessService {

	@Override
	public String getBillType() {
		return "EquipmentPurchaseApplicationlll";
	}

	@SuppressWarnings("unchecked")
	@Override
	public <T extends SuperEntity> Class<T> getMainEntityClass() {
		return (Class<T>) EquipmentTenderApplicationEntity.class;
	}
