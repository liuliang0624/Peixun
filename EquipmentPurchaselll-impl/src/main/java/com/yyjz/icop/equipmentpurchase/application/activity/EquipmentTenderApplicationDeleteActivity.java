 ...
 *     如需要扩展功能或者添加自定义实现，请在EquipmentTenderApplicationDeleteActivityExtend类中完成。 </p>
 */
@Activity
public abstract class EquipmentTenderApplicationDeleteActivity {

	@Autowired
	protected ReturnBillCodeRule<EquipmentTenderApplicationEntity> returnBillCodeRule;
	@Autowired
	protected DeleteTemplate<EquipmentTenderApplicationEntity> delete;

	public void delete(EquipmentTenderApplicationEntity[] entities) {
